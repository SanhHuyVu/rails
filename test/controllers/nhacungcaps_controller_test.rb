...
class NhacungcapsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nhacungcap" do
    assert_difference('Nhacungcap.count') do
      post nhacungcaps_url, params: { nhacungcap: { diachi: @nhacungcap.diachi, idnhacungcap: @nhacungcap.idnhacungcap, tennhacungcap: @nhacungcap.tennhacungcap, thongtindaidien: @nhacungcap.thongtindaidien } }
    end
  ...
  test "should update nhacungcap" do
    patch nhacungcap_url(@nhacungcap), params: { nhacungcap: { diachi: @nhacungcap.diachi, idnhacungcap: @nhacungcap.idnhacungcap, tennhacungcap: @nhacungcap.tennhacungcap, thongtindaidien: @nhacungcap.thongtindaidien } }
