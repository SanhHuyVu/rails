class NhacungcapsController < ApplicationController
  before_action :set_nhacungcap, only: %i[ show edit update destroy ]

  # GET /nhacungcaps or /nhacungcaps.json
  def index
    @nhacungcaps = Nhacungcap.all
  end

  # GET /nhacungcaps/1 or /nhacungcaps/1.json
  def show
  end
  ...
  # POST /nhacungcaps or /nhacungcaps.json
  def create
  ...
  # PATCH/PUT /nhacungcaps/1 or /nhacungcaps/1.json
  def update
    respond_to do |format|
  ...
  # DELETE /nhacungcaps/1 or /nhacungcaps/1.json
  def destroy
    @nhacungcap.destroy
    respond_to do |format|
  ...
  private
    ...
    def nhacungcap_params
      params.require(:nhacungcap).permit(:idnhacungcap, :tennhacungcap, :diachi, :thongtindaidien)
    end
end
